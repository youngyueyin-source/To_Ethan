...
const letters = {
    ...
    miss: {
        ...
        body: `
            ...
            <p>imagine our nights. showering/taking a bath together, laughing about our day, playing video games side by side, winding down together. then falling asleep in each others arms with the soft sound of the tv in the background. your hand finding mine without thinking.</p>
            ...
            <p>so hold onto this: one day, you won't have to miss me like this. one day, i'll be apart of your everyday, and you'll be apart of mine.</p>
            <h2>love, jade .✦ ݁˖</h2>
        `
    },
    laugh: {
    ...
    mad: {
        ...
        envelope: "images/paper.jpg",
        body: `
            <p>first, i want to thank you for all the times you've been patient with me. i know it isn't always easy. i know i can be sensitive, or overthink, or need reassurance in ways that aren't simple. and i never, and will never, take your patience for granted.</p>
            <p>i just ask that you continue to be patient with me as i grow. i've been through things that changed the way i see people. they've affected how i trust, how i react, and even how i see myself sometimes. that doesn't excuse my behavior, i know that. but i hope it explains why certain things hit me harder than they should. one thing about me is that i love and feel things so deeply (why else would i make this website just for you).</p>
            <p>the truth is, whatever difficulties we face, im glad its with you and no one else. even the uncomfortale conversations and the hard days because you make me feel safe in a way i've never felt before. sometimes this kind of safety feels almost foreign to me. i'm still learning how to exist inside something healthy without being afraid of losing it</p>
            <p>i am trying. i truly want to be better. i want to be the best version of myself for you because you matter to me that much.</p>
            <p>so if you're upset at me, or i'm upset at you, i want you to know that it does not mean the love is gone. not even close. sometimes love has to move through fustration before it settles again.</p>
            <p>also sometimes i need a little space to collect my thoughts. not because i'm pulling away, and not because i care less. if i try to confront everything immediately, i might crumble under my own emotions. space is how i make sure i respond with care instead of fear or heightened emotions. space does not equal absense of love.</p>
            <p>if anything, i get upset because i care so much. because i want us to work. i want us to both feel secure and happy and understood. so i will do better to communicate in general and when i need space. i promise i wont let you down.</p>
            <h2>love, jade .✦ ݁˖</h2>
        `
    }
};
